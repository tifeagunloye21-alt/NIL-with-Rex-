        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                ...
                <div style={{ background: 'linear-gradient(135deg, #0033cc 0%, #0052FF 60%, #2563eb 100%)', borderRadius: '20px', padding: '2rem', color: 'white', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <button
                        onClick={() => navigate('/agent-tracker')}
                ...
                <div style={{ background: 'white', borderRadius: '20px', padding: '1.5rem', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid #f1f5f9' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
                        ...
                        <Link to="/agent-deliverables" style={{ fontSize: '0.78rem', fontWeight: 600, color: '#0052FF', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.2rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                ...
                <div style={{ background: 'white', borderRadius: '20px', padding: '1.5rem', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', border: '1px solid #f1f5f9' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
                        ...
                        <Link to="/agent-education" style={{ fontSize: '0.78rem', fontWeight: 600, color: '#8b5cf6', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.2rem' }}>Continue <ArrowRight size={12} /></Link>
                    </div>
    ...
    return (
        <div style={{ background: 'white', borderRadius: '20px', padding: '1.75rem 2rem', boxShadow: '0 2px 12px rgba(0,0,0,0.05)', border: '1px solid #f1f5f9' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
                ...
                <button onClick={() => navigate('/agent/report-deal')} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', background: '#0052FF', color: 'white', border: 'none', borderRadius: '10px', padding: '0.6rem 1.2rem', fontWeight: 700, fontSize: '0.85rem', cursor: 'pointer' }}>
                ...
                <div style={{ textAlign: 'center', padding: '4rem 0', color: '#9ca3af' }}>
                    ...
                    {!showArchived && (
                        <>
                            ...
                            <button onClick={() => navigate('/agent/report-deal')} style={{ background: '#0052FF', color: 'white', border: 'none', borderRadius: '8px', padding: '0.65rem 1.4rem', fontWeight: 700, cursor: 'pointer' }}>+ Report Your First Deal</button>
                        </>
                    )}
                </div>
            ) : (
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{ background: 'linear-gradient(135deg, #ede9fe, #f5f3ff)', border: '1px solid #c4b5fd', borderRadius: '16px', padding: '1.25rem 1.5rem', display: 'flex', alignItems: 'center', gap: '1.25rem' }}>
                ...
                <button onClick={() => navigate('/agent-education')} style={{ marginLeft: 'auto', background: '#7c3aed', color: 'white', border: 'none', borderRadius: '10px', padding: '0.6rem 1.2rem', fontWeight: 700, fontSize: '0.85rem', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.75rem' }}>
                <div>
                    ...
                    <p style={{ color: '#6b7280', marginTop: '0.3rem', fontSize: '0.95rem' }}>
                        Your client management command center
                    </p>
                </div>
                <button
                    onClick={() => navigate('/agent/report-deal')}
